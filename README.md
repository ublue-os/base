...
This is a base Fedora Kinoite image designed to be customized to whatever you want, have GitHub build it for you, and then host it for you. You then just tell your computer to boot off of that image. GitHub keeps 90 days worth image backups for you, thanks Microsoft! 
...
Warning: This is an experimental feature and should not be used in production (yet), however it's pretty close)
    ...
    sudo rpm-ostree rebase ostree-unverified-registry:ghcr.io/polluxtroy3758/kinoite:latest
    
We build date tags as well, so if you want to rebase to a particular day's release:
  
    sudo rpm-ostree rebase ostree-unverified-registry:ghcr.io/polluxtroy3758/kinoite:20230204
...
- Mozilla Firefox, Mozilla Thunderbird, Libreoffice, DejaDup, FontDownloader, Flatseal, and the VLC Media Player
- Core KDE Applications installed from Flathub
...
These images are signed with sisgstore's [cosign](https://docs.sigstore.dev/cosign/overview/). You can verify the signature by downloading the `cosign.pub` key from this repo and running the following command:
    ...
    cosign verify --key cosign.pub ghcr.io/polluxtroy3758/kinoite
...
1. Change the [image name in the action](https://github.com/polluxtroy3758/kinoite/blob/328b67b7eeab93da1e1eda7fd2ecde55a4c52793/.github/workflows/build.yml#L14) to match what you want to call your image
   - Changing it to `IMAGE_NAME: beagles` will name the final image: `ghcr.io/yourusername/beagles` - so you'll likely want that to be your cool name instead of `kinoite`
